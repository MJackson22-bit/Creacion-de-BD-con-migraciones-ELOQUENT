...
@section('contenido')
    ...
    <div class="container" style="margin: 8px;">
        <a href="profesors/create" class="btn btn-info btn-lg">
            <span class="glyphicon glyphicon-plus"></span> Agregar un nuevo profesor
        </a>
    </div>
            ...
            <table class="table  table-dark">
                ...
                @foreach ($listaProfesor as $data)
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a href="{{ asset('profesors/' . $data->id) }}" class="btn btn-warning">
                                <span class="glyphicon glyphicon-pencil"></span> Editar
                            </a>
                            <a class="btn btn-success" href="{{ asset('profesors/delete/' . $data->id) }}">
                                <span class="glyphicon glyphicon-remove-sign"></span> Eliminar
                            </a>

                            <a class="btn btn-danger" href="{{ asset('profesors/relation/' . $data->id) }}">
